...
def generateRequest(requestNum,preferFileName,requestFileName):
...
if __name__ == "__main__":
    requestNum = 200000
    preferFileName = "prefer1.csv"
    requestFileName = "request1.csv"
    generateRequest(requestNum,preferFileName,requestFileName)
    print ("generate %d request"%requestNum)
    requestNum = 200000
    preferFileName = "prefer2.csv"
    requestFileName = "request2.csv"
    generateRequest(requestNum,preferFileName,requestFileName)
    print ("generate %d request"%requestNum)
    requestNum = 100000
    preferFileName = "prefer3.csv"
    requestFileName = "request3.csv"
    generateRequest(requestNum,preferFileName,requestFileName)
    print ("generate %d request"%requestNum)
